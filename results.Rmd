...
#check the relationship between income and disciplines:
museum_income <- within(museum_income,
                        INCOMECD15 <- factor(INCOMECD15,
                                             levels=names(sort(table(INCOMECD15),
                                                               decreasing=TRUE))))
ggplot(museum_income, aes(x = INCOMECD15, fill = GSTATE)) + geom_bar()+
  ggtitle("Income Level Distribution among All States")
```
