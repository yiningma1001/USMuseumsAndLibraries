...
4. The correlation between geographical locations and museums' income (revenue) levels is weak, which means that the current development of museums is according to local culture and history instead of being profit-seeking.
