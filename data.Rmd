...
And we choose to mainly analyse the discipline, income and ruledate 
...
### Museum Data
if MID is missing, we think it is not a valid museum record, and delete. 
There are 8677(28.8%) empty value in incomecd, and 8682(28.8%) emtpy value in rule data
Most missing cases are missing 1 variable, and some are missing two, which mean missing ruledata and incomecd are not strongly correlated.
```{r}
